...
# baseline n: 3027
# F/U: 2437 (80% retention)

# Table 1:
# p1 = 0.193
# p0 = 0.118 

# this could conform to the obesity paradox DAG:
# X --> prodromal symptoms (R) --> psychotic Sx
# and U could be some predisposing factor like familial predisposition

#**not ideal example because prodromal Sx are more like U than R itself


# https://www.bmj.com/content/bmj/330/7481/11.full.pdf?casa_token=I6NOZJo1i7sAAAAA:43k3yXuycdzmfV1A8otPKkm_z2wcHNAxuJuXoXgTZSC12iJlvYPU-pe9Z4iVwLaNXDtZZZ8-Pe8





# # ENTER DATA FROM OBESITY PAPER ----------------------------------
# # see annotated paper on OSF for notes on the origins of these numbers
# 
# # Table 1
# n.randomized.cntrl = 944  # normal weight males
# n.randomized.trt = 397  # obese males
# n.randomized.tot = n.randomized.trt + n.randomized.cntrl
# 
# # approximate P(R=1 | A=0) 
# #  i.e., P(CVD | normal)
# CVD.HR = 1.57  # obese vs. normal; Table 2
# CVD.RR = sqrt(CVD.HR)  # approximately transform because of common-ish outcome
# pr = 0.186  # beginning of Results
# ( pr.cntrl = pr / ( (n.randomized.cntrl/n.randomized.tot) + CVD.RR * (n.randomized.trt/n.randomized.tot) ) )
# ( pr.trt = pr.cntrl * CVD.RR )
# 
# n1.retained = round(n.randomized.trt * pr.trt)
# n0.retained = round(n.randomized.cntrl * pr.cntrl)
# n.retained = n1.retained + n0.retained
# 
# # mortality outcome
# pY = 0.287
# RR_AU = sqrt(0.67)
# pa = n1.retained/n.retained # P(obese | CVD)
# 
# ( p0 = pY / ( (1 - pa) + RR_AU*pa ) )
# ( p1 = p0 * RR_AU )
# 
# expect_equal( (p1/p0)^2, 0.67 )
# 
# 
# 
# 
...
# 
# 
# #bm: this example seems not great because CI crosses 1 already
# #  and I had to make a ton of approximations
# # also not that you need to change name args throughout to not have 
# #  multiple examples overwrite each other.
# 
# 
# # ~ E-values --------------------------
# 
